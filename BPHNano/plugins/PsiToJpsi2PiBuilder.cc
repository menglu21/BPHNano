////////////////////////////// Psi(2s)ToJpsi2PiBuilder //////////////////////////////
/// authors: Meng Lu
// takes the ditrack collection and a dilepton collection and produce Psi(2S)
...
class PsiToJpsi2PiBuilder : public edm::global::EDProducer<> {

  // perhaps we need better structure here (begin run etc)
public:
  typedef std::vector<reco::TransientTrack> TransientTrackCollection;

  explicit PsiToJpsi2PiBuilder(const edm::ParameterSet &cfg):
...
void PsiToJpsi2PiBuilder::produce(edm::StreamID, edm::Event &evt, edm::EventSetup const &iSetup) const {
...
//	std::cout << "ditrack with opposite charge: "<<std::endl;
	...
	auto psip4 = l1_p4 + l2_p4 + trk1_p4 + trk2_p4;
	cand.setP4(psip4);
...
DEFINE_FWK_MODULE(PsiToJpsi2PiBuilder);
